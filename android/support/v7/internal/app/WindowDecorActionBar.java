...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C01941();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C01952();
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C01863();

    class C01863 implements ViewPropertyAnimatorUpdateListener {
        C01863() {
        }
    ...
    class C01941 extends ViewPropertyAnimatorListenerAdapter {
        C01941() {
        }
    ...
    class C01952 extends ViewPropertyAnimatorListenerAdapter {
        C01952() {
        }
