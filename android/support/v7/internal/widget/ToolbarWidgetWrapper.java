...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C01992 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C02003 extends ViewPropertyAnimatorListenerAdapter {
        C02003() {
        }
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C01992());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C02003());
        }
    }
